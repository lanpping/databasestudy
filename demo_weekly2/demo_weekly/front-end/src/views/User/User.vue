  ...
  <div class="user-wrap">
      ...
      <el-row>
        ...
        <el-col :span="6">
          <el-form-item label="所有客服数" prop="parent">
            <el-input type="text" v-model="keywords.parent" placeholder="请输入所查服务商编码"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="间接客服数" prop="jjparent">
            <el-input type="text" v-model="keywords.jjparent" placeholder="请输入所查服务商编码"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
      </el-row>
    ...
    <div class="main-content">
      ...
      <el-table v-loading="!this.reqFlag.search" :data="tableData" header-row-class-name="table-header" border>
        ...
        <el-table-column prop="parent" label="用户编码" align="center"></el-table-column>
