  ...
  <el-dialog title="新增用户" :visible.sync="showFlag" custom-class="dialog-small" @close="closeDialog">
    <el-form ref="formData" :model="formData" :rules="formRules" label-width="80px">
      ...
      <el-form-item label="所属类型" prop="type">
        <el-input v-model="formData.type" placeholder="请输入数字(1代表管理员，2代表服务商，3代表客服)"></el-input>
      </el-form-item>
      <el-form-item label="所属服务商" prop="parent">
        <el-input v-model="formData.parent" placeholder="请输入用户所属服务商，无则填null"></el-input>
      </el-form-item>
