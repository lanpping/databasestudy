  ...
  <div class="user-wrap">
    ...
    <el-form v-if="userPower" class="main-search" :inline="true" :model="keywords" ref="keywords" :rules="searchRules" label-position="left" label-width="85px" size="medium">
      <el-row>
        ...
        <el-col :span="6">
          <el-form-item label="服务商名称" prop="parent">
            <el-input type="text" v-model="keywords.parent" placeholder="请输入服务商名称"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
    ...
    <div class="main-content">
      ...
      <el-table v-loading="!this.reqFlag.search" :data="tableData" header-row-class-name="table-header" border>
        ...
        <el-table-column prop="parent" label="所属服务商" align="center"></el-table-column>
