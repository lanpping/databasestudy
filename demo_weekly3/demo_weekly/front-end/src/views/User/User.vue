  ...
  <div class="user-wrap">
    ...
    <el-form v-if="userPower" class="main-search" :inline="true" :model="keywords" ref="keywords" :rules="searchRules" label-position="left" label-width="85px" size="medium">
      <el-row>
        ...
        <el-col :span="6">
          <el-form-item label="所有客服数" prop="parent">
            <el-input type="text" v-model="keywords.parent" placeholder="请输入上级ID"></el-input>
          </el-form-item>
        </el-col>
        <!-- <el-col :span="6">
          <el-form-item label="直接客服数" prop="parent">
            <el-input type="text" v-model="keywords.zjparent" placeholder="请输入服务商用户编码"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="间接客服数" prop="parent">
            <el-input type="text" v-model="keywords.jjparent" placeholder="请输入服务商用户编码"></el-input>
          </el-form-item>
        </el-col> -->
      </el-row>
      <el-row>
    ...
    <div class="main-content">
      <div v-if="userPower" class="content-header">
        <el-button type="primary" size="medium" @click="handleAdd">新增用户</el-button>
      </div>
      <el-table v-loading="!this.reqFlag.search" :data="tableData" header-row-class-name="table-header" border>
        ...
        <el-table-column prop="parent" label="上级ID" align="center"></el-table-column>
        ...
        <el-table-column label="操作" align="center" width="200">
          <template slot-scope="scope">
            <!-- < :disabled="scope.row.type==1" size="mini" @click="handleEdit(scope.row.id)">编辑</
            el-button> -->
...
export default {
  ...
  methods: {
    queryUserList () {
      ...
      if (this.reqFlag.search) {
        ...
        let params = {
          ...
          searchParent: this.keywordsParams.parent,
          searchZjParent: this.keywordsParams.zjparent,
          searchJjParent: this.keywordsParams.jjparent,
    ...
    handleDelete (id) {
      this.$common.msgBox('confirm', '操作提示', '是否确定删除此用户？', () => {
