  ...
  <div class="weekly-wrap">
      ...
      <el-row>
        <el-col :span="6">
          <el-form-item label="订单ID" prop="id">
            <el-input type="number" v-model.number="keywords.id" placeholder="请输入订单ID"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="订单名称" prop="title">
            <el-input v-model="keywords.title" placeholder="请输入订单名称"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="买家名称" prop="buyer">
            <el-input v-model="keywords.buyer" placeholder="请输入买家名称"></el-input>
          </el-form-item>
        </el-col>
        <el-col v-if="userPower" :span="6">
          <el-form-item label="客服ID" prop="userId">
            <el-select v-model="keywords.userId" filterable remote reserve-keyword placeholder="请选择客服id" :remote-method="queryUserList">
              <el-option
        ...
        <el-col :span="6">
          <el-form-item label="下单日期" prop="startTime">
            <el-input v-model="keywords.startTime" placeholder="请输入下单日期"></el-input>
          </el-form-item>
        </el-col>
        <!-- <el-col :span="6">
    ...
    <div class="main-content">
      ...
      <el-table v-loading="!this.reqFlag.search" :data="tableData" header-row-class-name="table-header" border style="width: 100%">
        ...
        <el-table-column prop="buyer" label="买家名称" align="center"></el-table-column>
        <el-table-column prop="startTime" label="下单时间" align="center"></el-table-column>
        <!-- <el-table-column prop="endTime" label="订单结束时间" align="center"></el-table-column> -->
        <el-table-column prop="userName" label="客服" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleDelete (id) {
      this.$common.msgBox('confirm', '操作提示', '是否确定删除此条订单信息？', () => {
