...
import OrdList from '@/components/morder/mord'

import YonList from '@/components/yonghu/yon'
...
// mode: 'history',
  routes: [
    ...
    },
    {
      ...
      iconCls: 'iconfont icon-books',
      children: [
        {path: '/morder/mord', component: OrdList, name: '订单列表', menuShow: true},
        {path: '/yonghu/yon', component: YonList, name: '用户列表', menuShow: true}
      ]
    },
    {
      path: '/',
